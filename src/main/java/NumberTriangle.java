...
public class NumberTriangle {
    ...
    public static NumberTriangle loadTriangle(String fname) throws IOException {
        ...
        ArrayList<NumberTriangle> perRow = new ArrayList<>();
        ...
        while (line != null) {
            ...
            for (String number : parts){
                curRow.add(new NumberTriangle(Integer.parseInt(number)));
            }
            ...
            if (top == null) {
                ...
                for (int i = 0; i < perRow.size(); i++){
                    perRow.get(i).setLeft(curRow.get(i));
                    perRow.get(i).setRight(curRow.get(i + 1));
                }
            }
